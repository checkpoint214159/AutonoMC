...
class Clip(nn.Module):
    ...
    updating it. Iteratively do this until the divergence / difference is small enough,
    then we backprop for PrefNet? Could also include 'complexity': loss term that penalizes
    for very different posterior compared to initial initial prior.
    """
    def __init__(
        self,
        embed_dim,
